...
export function NotFoundPage() {
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-lg flex-col items-center justify-center px-4 text-center">
      ...
      <p className="text-xs font-bold tracking-[0.2em] text-baazex uppercase">404</p>
      <h1 className="mt-3 text-4xl font-extrabold text-navy">This page is not on the curriculum</h1>
